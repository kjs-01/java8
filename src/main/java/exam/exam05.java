...
public class exam05 {
    ...
    public static void main(String ...args){
        ...
        System.out.println("1.Find all transactions from year 2011 and sort them by value" + "==============");
        ...
        //책이랑 좀 다름.
        System.out.println("6: Update all transactions so that the traders from Milan are set to Cambridge." + "==============");
        transactions.stream()
                .map(Transaction::getTrader)
